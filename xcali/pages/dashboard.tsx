  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="w-64 p-6 bg-indigo-600 text-white fixed h-full">
        ...
        <ul>
          <li className="mb-4">
            <Link href="/overview" className="text-lg hover:text-indigo-300">
              Overview
            </Link>
          </li>
          <li className="mb-4">
            <Link href="setting" className="text-lg hover:text-indigo-300">
              Settings
            </Link>
          </li>
          <li className="mb-4">
            <Link href="/faq" className="text-lg hover:text-indigo-300">
              Support
            </Link>
          </li>
        </ul>
